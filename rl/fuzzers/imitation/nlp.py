...
from ....data.fasttext import tokenize_code
...
class NLP:
    ...
    def embed_method(self, method):
        """
        transfer a method_name to a array[1,300]
        """
        if method in self.mem_embed:
            return self.mem_embed[method]
        self.mem_embed[method] = np.array(self.w2v.get_word_vector(method))
