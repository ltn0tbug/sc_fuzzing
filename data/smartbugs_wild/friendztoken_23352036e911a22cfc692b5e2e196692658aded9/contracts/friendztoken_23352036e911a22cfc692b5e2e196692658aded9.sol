...
contract FriendzToken is BurnableToken, Ownable {
    ...
    address private reserved_holder =
        0x26226CfaB092C89eF3D79653D692Cc1425a0B907;
    ...
    function transfer(
        address _to,
        uint _value
    ) public canTransfer(msg.sender, _value) returns (bool success) {
